...
def readingScore():
    text_file = open("files/score.txt", "r")
    highScore = text_file.read()
    return int(highScore)
    text_file.close

def saveScore(high_score, newScore):

    score = str(newScore)
    if newScore > high_score:
        high_score = score
        output_file = open("files/score.txt", "w")
    ...
    while not gameQuit:
        ...
        while not gameOver:
            ...
            if playerDino.isDead:
                gameOver = True
                saveScore(high_score, playerDino.score)
